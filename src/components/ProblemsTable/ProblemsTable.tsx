...
const ProblemsTable: React.FC<ProblemsTableProps> = ({ setLoadingProblems }) => {
	...
	const solvedProblems = useGetSolvedProblems(); // Placeholder for solved problems data
...
function useGetSolvedProblems() {
	...
	useEffect(() => {
		// Mocking solved problems for demonstration
		const mockSolvedProblems = ["two-sum"]; // Assuming problem ID "1" is solved
